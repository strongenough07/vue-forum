<template>
  <div class="profile-card">
    ...
    <UserPorfileCardEditorReauthenticate
      v-model="needsReAuth"
      @success="onReauthenticate"
...
import UserPorfileCardEditorReauthenticate from "./UserPorfileCardEditorReauthenticate.vue";
export default {
  components: {
  ...
  methods: {
    ...
    async handleRandomAvatarUpload() {
      const randomAvatarGenerated = await this.activeUser.avatar.startsWith(
        "https://pixabay"
      );
